...
M1 <- read.table("stability.CHAEFecal.0.03.Top30.pearson.otu.corr", header = TRUE, sep="\t", as.is=T)
...
## Column 4 is the p-value of the correlation.
## If the p-value of a particular correlation is above 0.05 then it is disregarded.
M2 <- read.table("stability.CHAEGut.0.03.Top30.pearson.otu.corr", header = TRUE, sep="\t", as.is=T)
