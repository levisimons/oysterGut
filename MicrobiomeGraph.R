...
Top30 <- read.table("stability.opti_mcc.label.Top30.shared.tsv", header = TRUE, sep="\t", as.is=T)
Top30 <- Top30[ -c(1:3)]
M <- cor(Top30)
...
corrplot(M, p.mat = res1[[1]], sig.level=0.05, insig = "blank", tl.cex=0.6, method="pie") #plot matrix
